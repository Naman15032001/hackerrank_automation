...
browserOpen.then(function(browser){
    ...
    let loginEnterp=page.click("button[data-analytics='LoginPassword']",{delay:50});
    return loginEnterp;
}).then(function(){
   ...
   // page.click("div[data-automation='algorithms']",{delay:50});
    ...
    let allChallenge = page.$$(".ui-btn.ui-btn-normal.primary-cta.ui-btn-line-primary.ui-btn-styled",{delay:50});
    return allChallenge;
...
function questionSolver(page,question,answer){
    ...
    return new Promise(function(resolve,reject){
        ...
        clickQue.then(function(){
            ...
            let vPress=page.keyboard.press('V',{delay:100});
            return vPress;
        }).then(function(){
